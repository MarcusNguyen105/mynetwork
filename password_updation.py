...
def funcUpdation(currPassword, newPassword):
    ...
    # This problem requires finding minimum insertions and deletions
    # We can solve this using Longest Common Subsequence (LCS)
    # Formula: deletions + insertions = len(curr) + len(new) - 2*LCS_length
