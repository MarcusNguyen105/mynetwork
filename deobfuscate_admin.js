...
function _0x3476(_0x24cc5b,_0x2b4f98){
    ...
    return _0x3476=function(_0x224fec,_0x1e2820){
        _0x224fec=_0x224fec-0x146;
        var _0x4a390d=_0x2da9db[_0x224fec];
        return _0x4a390d;
    },_0x3476(_0x24cc5b,_0x2b4f98);
}

// _0x32e5 function - builds array using _0x3476
function _0x32e5(){
    var _0x5a1ae8=_0x3476,_0x5b28f4=[_0x5a1ae8(0x16c),_0x5a1ae8(0x164),_0x5a1ae8(0x14f),')\x20tamrof\x20g',_0x5a1ae8(0x163),_0x5a1ae8(0x152),_0x5a1ae8(0x154),_0x5a1ae8(0x153),'IxZg==',_0x5a1ae8(0x15b),'eht\x20kcarc',_0x5a1ae8(0x14d),_0x5a1ae8(0x156),'9VFwNrg',_0x5a1ae8(0x146),_0x5a1ae8(0x16f),_0x5a1ae8(0x148),_0x5a1ae8(0x15d),_0x5a1ae8(0x168),_0x5a1ae8(0x16e),'287AWNVHd','6161343030',_0x5a1ae8(0x157),_0x5a1ae8(0x149),_0x5a1ae8(0x172),_0x5a1ae8(0x155),_0x5a1ae8(0x179),_0x5a1ae8(0x14e),_0x5a1ae8(0x14a),'etanetacno','178842lPRJmm','1392482zqhnOI'];
    return _0x5b28f4;
}
...
function _0x4deb(_0x5de5a9,_0xabcebe){
    ...
    return _0x4deb=function(_0x11db13,_0x3f63a1){
        _0x11db13=_0x11db13-(0x9b*0x15+-0x17a6+0xccf);
        var _0x400144=_0x224507[_0x11db13];
        return _0x400144;
    },_0x4deb(_0x5de5a9,_0xabcebe);
}

var _0x34b85e=_0x4deb;

// Now decode hash1, hash2, and instruction
...
// Try to decode if they're encoded
console.log('\n--- Trying various decodings ---');

// Reverse instruction (seems backwards)
console.log('instruction reversed:', instruction.split('').reverse().join(''));

// Try base64 decoding hash1 and hash2
try {
    console.log('hash1 + hash2:', hash1 + hash2);
    console.log('hash1 + hash2 base64 decoded:', Buffer.from(hash1 + hash2, 'base64').toString());
} catch(e) {
