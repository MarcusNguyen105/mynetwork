...
def try_different_approach():
    """Try a different approach to get the flag"""
    ...
    # Try to send 7 with different techniques
    techniques = [
        b"7\n",
        b"7 \n",
        b" 7\n",
...
def try_buffer_overflow_different():
    """Try buffer overflow with different approach"""
    sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    sock.connect(("chals.uscc-cyberbowl-2025.ctf.institute", 3015))
...
def main():
    ...
    print("\n=== Trying buffer overflow with different approach ===")
    try_buffer_overflow_different()
